        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        :href="route('home')"
                        :active="request()->routeIs('home') || request()->routeIs('filter')"
                    >
                        {{ __("Home") }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        :href="route('addPost')"
                        :active="request()->routeIs('addPost')"
                    >
                        {{ __("Add Post") }}
                    </x-nav-link>
                </div>
                ...
                >
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            >
                                <div
                                    class="text-gray-400 dark:hover:text-gray-300 transition duration-150 ease-in-out"
                                >
                                    My posts
                                </div>
                                <div class="ml-1">
                                    <svg
                                        class="fill-gray-400 h-4 w-4"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link
                :href="route('home')"
                :active="request()->routeIs('filter') || request()->routeIs('home')"
            >
                {{ __("Home") }}
            </x-responsive-nav-link>
        </div>
